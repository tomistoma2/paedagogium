...
useEffect(() => {
    let m = domain.domain+"parse/courses/read/registration";
...
<Paper sx={{width: '55%', display: 'block', margin: 'auto', marginTop: '25px', padding: '35px', marginBottom: '200px', '@media(max-width: 920px)': {marginTop: '300px', width: '85%'}}}>
<div dangerouslySetInnerHTML={{ __html: data3.results }}></div>
</Paper><br></br><Analytics/>
<Footer></Footer>
</div>
);
}
