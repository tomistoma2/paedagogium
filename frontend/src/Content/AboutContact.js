...
import background from '../Media/background2.jpg';import Link from '@mui/material/Link';
...
useEffect(() => {
let m = domain.domain+"parse/about/read/contact";
...
return(
    ...
    <img style={{ width: '200px', display: 'block', margin: 'auto', marginBottom: '5px',}} src={logo} alt="Pedagogoium logo"
      onClick={() => (window.location.href = domain.domain)}/>
        ...
        <Paper sx={{width: '55%', display: 'block', margin: 'auto', marginTop: '50px', padding: '35px', '@media(max-width: 1400px)': { marginTop: '275px', width: '85%'  }}}>
